...
/***/ function(module, exports, __webpack_require__) {
	...
	var GaugeList = function (_React$Component) {
	  _inherits(GaugeList, _React$Component);

	  function GaugeList() {
	    _classCallCheck(this, GaugeList);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(GaugeList).call(this));
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        this.data.map(function (boroughData) {
	          return React.createElement(Gauge, { data: boroughData });
	        })
	      );
	    }
	  }]);
	...
	var Gauge = function (_React$Component2) {
	  _inherits(Gauge, _React$Component2);
	  ...
	  _createClass(Gauge, [{
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          'svg',
	          { 'class': 'gauge', width: '140', height: '140', viewbox: '0 0 140 140' },
	          React.createElement('circle', { className: 'gauge--outer', r: '50', cx: '75', cy: '75' }),
	          React.createElement('circle', { className: 'gauge--inner', r: '50', cx: '75', cy: '75', stroke: this.props.data.color, strokeDashoffset: this.state.gaugeFill })
	        ),
	        React.createElement(
	          'p',
	          { className: 'gauge-number' },
	          this.props.data.healthyPercentage,
	          '%'
	        ),
	        React.createElement(
	          'p',
	...
	ReactDOM.render(React.createElement(GaugeList, null), document.getElementById('gaugeList'));

	window.treeData = __webpack_require__(176);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (process.env.NODE_ENV !== 'production') {
	  ...
	  var ReactNativeOperationHistoryDevtool = __webpack_require__(31);
...
/***/ function(module, exports) {
	...
	var baseUri = 'https://data.cityofnewyork.us/resource/';
	var data2015 = 'uvpi-gqnh';

	var TreeData = function TreeData() {
